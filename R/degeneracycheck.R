...
degeneracy.check <- function(object){


  #observed statistics
  observed <- object$observed.statistics

  # simulated statistics
  simulated.stat <- object$obs.sim.statistics
  ...
  rownames(Results)<- colnames(object$obs.sim.statistics)
